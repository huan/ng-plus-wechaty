...
async function main () {
  // Load the model.
  console.info('Loading QnA model...')
  const model = await qna.load(
    // {
    //   fromTFHub: true,
    //   modelUrl: 'https://tfhub.dev/tensorflow/tfjs-model/mobilebert/1',
    // }
  )

  // Finding the answers
  console.info('findAnswers for question:', question)
